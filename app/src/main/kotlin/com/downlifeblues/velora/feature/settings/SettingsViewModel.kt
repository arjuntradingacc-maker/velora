package com.downlifeblues.velora.feature.settings

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.downlifeblues.velora.data.repository.AccountProfile
import com.downlifeblues.velora.data.repository.AppSettings
import com.downlifeblues.velora.data.repository.AppTheme
import com.downlifeblues.velora.data.repository.AuthRepository
import com.downlifeblues.velora.data.repository.Density
import com.downlifeblues.velora.data.repository.SettingsRepository
import com.downlifeblues.velora.data.repository.SyncRepository
...
class SettingsViewModel @Inject constructor(
    ...
    fun manualSync(onResult: (Boolean) -> Unit) {
        viewModelScope.launch {
            ...
            onResult(result is com.downlifeblues.velora.data.repository.SyncOutcome.Success)
        }
    }
