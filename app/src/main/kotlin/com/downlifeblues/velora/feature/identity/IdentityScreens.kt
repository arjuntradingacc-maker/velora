...
private fun InfoLine(label: String, value: String) {
    ...
    Column(modifier = Modifier.padding(vertical = VeloraSpacing.xs)) {
        Text(label, style = com.downlifeblues.velora.core.design.VeloraType.label, color = colors.textSecondary)
        Text(value, style = com.downlifeblues.velora.core.design.VeloraType.body, color = colors.textPrimary)
    }
}
