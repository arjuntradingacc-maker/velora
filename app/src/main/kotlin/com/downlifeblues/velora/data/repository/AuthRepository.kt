...
import com.downlifeblues.velora.core.security.SecureVaultPrefs
import com.downlifeblues.velora.core.security.VaultKeyManager
 ...
 * [com.downlifeblues.velora.data.remote.AuthApi]) only ever authenticates *who you
...
class AuthRepository @Inject constructor(
    ...
    val sessionState: Flow<Boolean> = sessionManager.session.map { it is com.downlifeblues.velora.core.security.VaultSession.Unlocked }
