...
class SyncRepository @Inject constructor(
    ...
    suspend fun sync(encryptedRecords: List<com.downlifeblues.velora.data.remote.EncryptedVaultRecord>): SyncOutcome {
        return runCatching {
            syncApi.push(com.downlifeblues.velora.data.remote.SyncPushRequest(currentDeviceId(), encryptedRecords))
